...
%
% ── Datos de la portada: editá SOLO estas cinco líneas ──────────────────────
\newcommand{\Autora}{Erika Jimenez}
\newcommand{\Materia}{Práctica Módulo 1}
\newcommand{\Institucion}{Diplomado de AI · Augmented Humans}
\newcommand{\Fecha}{31 de julio de 2026}
\newcommand{\Repo}{https://github.com/tinmarin-do/hermes/tree/diplomado/medallion/medallion}
% ───────────────────────────────────────────────────────────────────────────
...
\hypersetup{colorlinks=true, linkcolor=acento, urlcolor=acento, citecolor=acento,
  pdftitle={Arquitectura medallón para un corpus de noticias de mercado},
  pdfauthor={\Autora}, pdfsubject={\Materia\ --- \Institucion},
  pdfkeywords={medallón, bronze, silver, gold, DuckDB, FAISS, \Repo}}
...
\author{\Autora \\ \small \Materia\ ---\ \Institucion \\[0.5em]
  \small Código y evidencia: \href{\Repo}{\texttt{github.com/\allowbreak tinmarin-do/\allowbreak hermes}} \\
  \footnotesize rama \texttt{diplomado/medallion} \textperiodcentered\ carpeta
  \texttt{medallion/}}
\date{\Fecha}
...
El código completo ---incluida la evidencia citada en este informe--- está
público en \href{\Repo}{\texttt{github.com/\allowbreak tinmarin-do/\allowbreak hermes}}, rama
\texttt{diplomado/medallion}, carpeta \texttt{medallion/}.

\begin{lstlisting}[language=bash, caption={Reproducción completa desde cero.}]
git clone -b diplomado/medallion https://github.com/tinmarin-do/hermes.git
cd hermes/medallion
