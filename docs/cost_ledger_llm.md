...
| 2026-07-05 | a0670332 | DeepSeek V4 Flash | all (22 llamadas — daily autónoma día 2: verdict HOLD 80% + allocator convergido (targets ≈ libro, 0 deltas sobre umbral, 0 fees); wallet $556.06; guard 1-sola ✓; línea diaria pre-autorizada) | 50230 | 0.0093 | 0.2181 | 149.7819 |
| 2026-07-07 | 6d3213c5 | DeepSeek V4 Flash | all (22 llamadas — validación v10/v8 de la REVISIÓN FINAL (estándar re-run): verdict HOLD 80% convergido, banda anti-churn 5% activa, gate VaR duro y guard UTC en producción; nota: por fecha UTC esta corrida suple a la programada del 07-07 14:10Z — guard la bloqueará, tradeoff documentado) | — | 0.0118 | 0.2392 | 149.7608 |
| 2026-07-08 | 3fe4e50a | DeepSeek V4 Flash | all (22 llamadas — daily autónoma 08:10 MX (v10, pre-deploy): verdict HOLD → 0 órdenes pese a señal ETH-only; reconciliada por la sesión del deploy; línea diaria pre-autorizada) | — | 0.0087 | 0.2479 | 149.7521 |
| 2026-07-08 | 67f48b77 | DeepSeek V4 Flash | all (22 llamadas — validación v11/v9 PR #38 (estándar re-run, jobs.run emergency): 3 streams OK (news-forward 6 vectores día 1/90 · voltarget 6 filas m=1.0 warmup · panel P&L). NOTA: comité dio BUY 80% donde el daily 08:10 dio HOLD → allocator ejecutó rebalanceo real SOL/LINK/XRP→ETH (4/4 FILLED: sells $325.27 + BUY ETH $145.08, fees hoy $1.69, realized −$25.20 — mercado a la baja desde 4-jul); misma señal champion en ambas corridas, difirió el veredicto LLM) | 42533 | 0.0078 | 0.2557 | 149.7443 |
| 2026-07-09 | 3fc1f8d6 | DeepSeek V4 Flash | all (22 llamadas — daily autónoma 08:10 MX (v11/v9, post-deploy PR #38): verdict HOLD (conf 80%) convergido con el libro (BTC w=+0.001, ETH w=+0.460, ambos bajo umbral de rebalanceo), 0 órdenes; 18 filas shadow (6 champion + 6 ml + 6 voltarget) + 6 vectores news-forward persistidos; equity $535.78 (+$3.28 vs ayer); línea diaria pre-autorizada) | 46904 | 0.0087 | 0.2644 | 149.7356 |
| 2026-07-10 | 0806d6fc | DeepSeek V4 Flash | all (22 llamadas — 1ra corrida real de `hermes-manual-verify` (PR #39, gate execute): validación dry-run post-apply — verdict HOLD (conf 80%), 0/2 legs activos, `Modo: 🔍 DRY-RUN` en log, `[execution] sin legs para ejecutar`, balance sin cambios ($288.86); `POST /run?force=true&execute=false` → 200 OK; línea diaria pre-autorizada) | 47471 | 0.0088 | 0.2732 | 149.7268 |
